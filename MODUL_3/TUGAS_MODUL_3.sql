...
SELECT qty*harga AS total_beli FROM tr_penjuatr;
...
SELECT nama_produk, qty > 3 FROM tr_penjuatr;
...
--- Praktek 11
--- Mengambil data nama_produk, dan qty dari tabel penjuatr yang qty lebih dari 3
SELECT nama_produk, qty FROM tr_penjuatr WHERE qty>3;
...
--- Praktek 14
--- Mengambil nama_produk dari tabel penjuatr yang nama produknya memiliki huruf 'f' sebagai awal kata
SELECT nama_produk 
FROM tr_penjuatr 
...
--- Latihan Mandiri 4
--- Ambil nama_produk yang memiliki karakter kedua ‘a’ pada table tr_penjuatr
SELECT nama_produk 
FROM tr_penjuatr 
